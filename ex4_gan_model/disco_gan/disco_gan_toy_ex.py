...
from disco_gan.data_gmm import GMM_distribution, sample_GMM, plot_GMM
from disco_gan.data_utils import shuffle, iter_data
...
""" Networks """
def generative_network(z, input_dim, n_layer, n_hidden, eps_dim, reuse=None):
...
def inference_network(x, latent_dim, n_layer, n_hidden, eps_dim, reuse=None):

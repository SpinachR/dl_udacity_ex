...
class SuperPointFrontend(object):
    ...
    def run(self, img):
        ...
        print('semi shape', semi.shape)  # 1, 65,  W/8, H/8
        print('coarse_desc shape', coarse_desc.shape)  # 1, 265,  W/8, H/8
        ...
        print('final heatmap shape: ', heatmap.shape)   #  W, H
        ...
        if pts.shape[1] == 0:
            ...
            samp_pts = torch.from_numpy(pts[:2, :].copy())  # only obtain the locations: first two rows
            ...
            desc = torch.nn.functional.grid_sample(coarse_desc, samp_pts)  # sample the channel according to the pt locations
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input', type=str, default='assets/icl_snippet/',
    ...
    while True:
        ...
        # plot_imgs(
        #     [cv2.drawKeypoints(img1_orig, kp1, None, (0, 0, 255)), disp(keypoint_map1), disp(keypoint_before_nms)],
        #     cmap='gray', dpi=200)
